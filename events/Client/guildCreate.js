...
module.exports = {
    ...
    async execute(guild, client) {
        try {
            ...
            console.log(`Joined Guild: ${guild.name} | Guild ID: ${guild.id} | Owner ID: ${guild.ownerId} | Members: ${guild.memberCount}`)
           ...
           console.log(`Guild: ${guild.name} | Guild ID: ${guild.id} | Event: guildCreate | ${err}`) 
        }
    }
}